            ...
            <div style="padding: 40px 30px;">
                @if($candidate)
                    ...
                    <div style="display: flex; align-items: center; gap: 25px; margin-bottom: 40px; padding-bottom: 30px; border-bottom: 2px solid var(--border-color);">
                        <div class="name-avatar" style="width: 150px; height: 150px; font-size: 32px;">
                            <img src="{{ $candidate->profile_photo }}" alt="Candidate Photo" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                        </div>
                        <div style="flex: 1;">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $candidate->reg_country ?? 'N/A' }}</span>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $candidate->mobile ?? 'N/A' }}</span>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $candidate->secondmobile ?? 'N/A' }}</span>
                    </div>
                ...
                <div style="margin-top: 40px; text-align: center;">
                    <a href="{{ route('candidate.personal_details.edit') }}" class="btn btn-primary" style="padding: 14px 40px; font-size: 15px;">
                ...
                @else
                    ...
                    <div style="text-align: center; padding: 60px 20px;">
                        ...
                        <a href="{{ route('candidate.personal_details.create') }}" class="btn btn-primary" style="padding: 14px 40px; font-size: 15px;">
